		...
		while(appData.appStateIs(AppData::AppState::RUNNING)) {
            ...
            if (appData.params.show) {
                ...
                if((appData.params.beadsearch_G || appData.params.beadsearch_R) && (appData.params.show_markers || appData.params.show_labels)) {
                    ...
                    if(appData.params.beadsearch_G && (appData.params.displayImageType==ImageType::RAW_G || appData.params.displayImageType==ImageType::BACKPROP_G)) {
                    ...
                    if(appData.params.beadsearch_R && (appData.params.displayImageType==ImageType::RAW_R || appData.params.displayImageType==ImageType::BACKPROP_R)) {
